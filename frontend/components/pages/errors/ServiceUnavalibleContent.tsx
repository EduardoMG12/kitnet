...
const ServiceUnavalibleContent = () => {
    ...
    return (
        <div className="h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-blue-900/20 p-4">
