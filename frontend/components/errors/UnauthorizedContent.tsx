...
const UnauthorizedContent = () => {
    ...
    return (
        <MainLayout hideFooter>
            <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center bg-gradient-to-b from-yellow-50 to-orange-100 dark:from-gray-900 dark:to-yellow-900/20 p-4">
